...
extension AppTextStyle on TextStyle {
  // Colors
  TextStyle cTitle() => copyWith(color: NoteAppColor.colorTextTitle);
  TextStyle cContent() => copyWith(color: NoteAppColor.colorTextContent);
  TextStyle cPhuDe() => copyWith(color: NoteAppColor.colorTextPhude);
