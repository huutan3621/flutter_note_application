...
import 'package:huutan_note_app/features/global/presentation/base_screen/base_screen.dart';
                  ...
                  children: [
                    ...
                    Text(
                      ...
                      style: tStyle.paragraph18().w500().copyWith(
                            color: NoteAppColor.colorTextTitle,
                          ),
                    ),
                    const SizedBox(
                      height: 12,
                    ...
                    Text(
                      ...
                      style: tStyle
                          .paragraph14()
                          .w400()
                          .copyWith(color: NoteAppColor.colorTextPhude),
                    ),
                    const SizedBox(
                      height: 20,
                    ),
